...
namespace Stomotologia1
{
    public partial class Form4 : Form
    {
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            this.appointmentsTableAdapter.Update(this.stomotologiaDataSet.Appointments);
            dataGridView1.Refresh();
        }

        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            if (dataGridView1.DataSource == appointmentsBindingSource)
            {
                appointmentsBindingSource.Filter = "[Diagnosis] LIKE'" + textBox1.Text + "%'";
                this.dataGridView1.DataSource = appointmentsBindingSource;
            }
        }
    }
}
